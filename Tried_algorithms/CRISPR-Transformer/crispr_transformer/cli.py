...
def build_parser() -> argparse.ArgumentParser:
    ...
    reservoir = commands.add_parser("reservoir", help="export an unmodified paper reservoir frontier")
    ...
    train.add_argument("--target-temperature", type=float, default=0.08)
