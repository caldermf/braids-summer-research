#!/usr/bin/env bash
#SBATCH --job-name=struct-validate
#SBATCH --partition=scavenge_gpu
#SBATCH --gpus=1
#SBATCH --cpus-per-task=2
#SBATCH --mem=16G
#SBATCH --time=00:20:00
#SBATCH --output=slurm_logs/struct_validate_%j.out
#SBATCH --error=slurm_logs/struct_validate_%j.err
...
MARKER="${MARKER:-$REPO_ROOT/results/structural_kernel/validation/scavenge_gpu_validated.json}"
cd "$REPO_ROOT"
