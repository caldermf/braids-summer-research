#!/usr/bin/env bash
#SBATCH --job-name=ct2-train
#SBATCH --partition=scavenge_gpu
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=12:00:00
#SBATCH --output=slurm_logs/ct_train_%j.out
#SBATCH --error=slurm_logs/ct_train_%j.err
...
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_ROOT/results/crispr_transformer_v2/p${P}/model_seed${SEED}}"
EPOCHS="${EPOCHS:-30}"
