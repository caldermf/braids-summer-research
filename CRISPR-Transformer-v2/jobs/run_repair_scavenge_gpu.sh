...
DATASET_DIR="${DATASET_DIR:-$REPO_ROOT/results/crispr_transformer_v2/p${P}/dataset_seed${DATASET_SEED}}"
MODEL="${MODEL:-$REPO_ROOT/results/crispr_transformer_v2/p${P}/model_seed${MODEL_SEED}/geometry_transformer_p${P}.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_ROOT/results/crispr_transformer_v2/p${P}/${MODE}_repair_seed${SEED}}"
